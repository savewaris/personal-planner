...
export const HabitTrackerFeed: React.FC<HabitTrackerFeedProps> = ({
  ...
  const [editingHabit, setEditingHabit] = useState<EditItemData | null>(null);
  ...
  const handleSaveEdit = async (id: string, updates: { name: string }) => {
    if (onUpdateHabit) {
