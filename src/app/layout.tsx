...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} dark h-full antialiased`}>
      <body className="min-h-full bg-zinc-950 text-zinc-100 font-sans transition-colors duration-200">
        <Providers>
          <div className="flex min-h-screen w-full bg-zinc-950 text-zinc-100 bg-grid relative">
